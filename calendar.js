...
function calendar()
{
	...
	days_week = new Array('Sun','Mon','Tue','Wed','Thur','Fri','Sat')
        ...
        for(i=1;i<=total;i++)
        {
                ...
                if(day==i)
                {
                        document.write('<td  id="t" class="currdate">{{result.results.channel.item.condition.temp + " " + result.results.channel.item.condition.text}}</td>');
                }
                else
                {
        ...
        for(i=1;week!=0;i++)
        {
                document.write('<td class="daynone">'+i+'</td>');
                week++;
                if(week==7)
                {
                        document.write('</tr>');
